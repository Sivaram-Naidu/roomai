    ...
    <nav className="relative z-50 px-6 py-4">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        >
          ...
          <a href="#workflow" className="text-white hover:text-orange-400 transition-colors font-medium">Process</a>
          <a href="#internship" className="text-white hover:text-orange-400 transition-colors font-medium">Internship</a>
